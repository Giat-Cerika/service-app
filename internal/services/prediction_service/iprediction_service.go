...
type IPredictionService interface {
	...
	SendPredictToStudent(ctx context.Context, req predictionrequest.PredictToStudentRequest) error
	GetPredictionByStudent(ctx context.Context, userId uuid.UUID) ([]*models.PredictHistory, error)
}
